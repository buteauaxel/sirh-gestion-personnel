	...
	<header>
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<img class="navbar-brand"
				src="<%=request.getContextPath()%>/img/sing.ico" class="rounded ">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav">
					<li class="nav-item active"><a class="nav-link" href="lister">Collaborateurs
		...
		<div class="mx-5">
			...
			<div class="row">
				...
				<div class="col-12 col-lg-1">
					<a href="creer" class="btn btn-primary mt-3">Ajouter un nouveau
						collaborateur</a>
				</div>
			</div>
				...
				<div class="col-12 col-mb-6 col-lg-4">
					<div class="card bg-light mb-3">
						...
						<div class="row">
							<div class="col-12 col-lg-4">
								<div class="card-body">
									<img src="<%=request.getContextPath()%>/img/sing.ico.jpg" class="rounded">
								</div>
							</div>
							<div class="col-12 col-lg-8">
								<div class="card-body">
									...
									<div class="row">
										...
										<div class="col-6"><%=c.getMatricule()%></div>
									</div>
									<div class="row">
										<div class="col-6">Numéro de sécurité sociale:</div>
										<div class="col-6"><%=c.getNumeroSecuriteSociale()%></div>
									</div>
									<div class="row">
									...
									<div class="row">
										...
										<div class="col-6"><%=c.getAdresse()%></div>
									</div>
									<div class="row">
										<div class="col-lg-6"></div>
										<div class="col-12 col-lg-3">
											<a href="editer" class="btn btn-primary mt-3">Editer</a>
										</div>
									</div>
									</p>
								</div>
